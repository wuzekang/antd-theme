...
function setTheme(theme) {
    ...
    load_themed_styles_1.loadTheme(variables);
    return variables;
}
...
exports.ThemeProvider = function (_a) {
    ...
    var state = react_1.default.useMemo(function () { return (__assign(__assign({}, theme), { themes: themes, current: variables })); }, [theme, variables]);
